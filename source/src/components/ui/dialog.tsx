...
const Dialog = ({ modal, ...props }: React.ComponentProps<typeof DialogPrimitive.Root>) => {
  ...
  // In a split pane, force non-modal so the other pane stays interactive.
  const effectiveModal = paneContainer ? false : modal;
...
const DialogOverlay = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Overlay> & { scoped?: boolean }
...
>(({ className, children, ...props }, ref) => {
  const paneContainer = usePaneContainer();
  const scoped = !!paneContainer;
  return (
    <DialogPortal container={paneContainer ?? undefined}>
      ...
      <DialogPrimitive.Content
        ...
        onPointerDownOutside={(e) => {
          if (scoped && paneContainer && !paneContainer.contains(e.target as Node)) {
            e.preventDefault();
          }
