...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  getUpdateSource: () => ipcRenderer.invoke("update:get-source"),
  setUpdateSource: (patch) => ipcRenderer.invoke("update:set-source", patch),
  resetUpdateSource: () => ipcRenderer.invoke("update:reset-source"),
